...
library.theme = {
	...
	tabstextcolor = Color3.fromRGB(210, 210, 210), 
	bordercolor = Color3.fromRGB(75, 210, 255), 
	accentcolor = Color3.fromRGB(210, 210, 210), 
	accentcolor2 = Color3.fromRGB(110, 110, 110), 
...
function library:CreateWindow(name, size, hidebutton)
	local window = {}
	window.name = name or ""
	window.size = UDim2.fromOffset(size.X, size.Y) or UDim2.fromOffset(500, 480)
